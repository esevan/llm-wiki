...
| F32 | Refinement proposal document preview; `RefinementPanel.tsx` | proposal readback renders beside the conversation | session loaded; the conversation and unapplied proposal document remain visible together, including empty/generating states | P(part): packaged proposal visibility; responsive split geometry and long-field scrolling require rendered visual review |
