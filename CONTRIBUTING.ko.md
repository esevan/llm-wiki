...
- Capture를 Problem과 Solution으로 바꾸기 전에 실제 도메인 관계, 독립 lifecycle, 원본 근거를 모델링하세요. 제품에 없는 1:1 연결을 강제하지 마세요.
- 이미 도출한 Solution은 다시 탐색하지 말고 입력으로 사용하세요. 기계적인 승인을 품질 근거로 삼지 마세요.
