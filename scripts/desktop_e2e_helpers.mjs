...
export const DESKTOP_E2E_SCENARIO_NAMES = Object.freeze(("task-capture,task-worklog,task-refinement,task-relationships,task-review,task-publication,task-problem-resolution,task-persistence,task-localization,task-bilingual-refinement,task-controls,task-workbench-retry,task-legacy-refinement,task-legacy-chat-controls,task-legacy-preview-retry,task-chat-controls,task-refinement-provider-recovery,task-refinement-close-retry,task-refinement-close-pending,task-refinement-relaunch,task-work-session-restart,task-codex-execution,task-mcp-continuation,global-shell,global-search,global-compass,global-provider,global-mcp,global-queue-notifications,global-notice,global-intro-navigation,global-intro-retry,global-vault-choose,global-vault-retry,global-migration-restore,global-migration-retry").split(","));
