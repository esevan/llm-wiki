...
function IconAction({ dialog, label, id }: { dialog: string; label: string; id?: string }) {
  return <button id={id} type="button" className="tiny icon-action" data-tooltip={label} aria-label={label} onClick={() => closeDialog(dialog)}>×</button>;
}
