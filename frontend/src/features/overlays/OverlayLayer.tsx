...
export function OverlayLayer() {
  ...
  return (
    <div className="overlay-layer">
      ...
      <div className="alert-dock"><button id="alert-toggle" className="alert-toggle" aria-label="Notifications" aria-expanded="false">🔔</button><span id="alert-badge" className="alert-badge" hidden>0</span><section id="alert-panel" className="alert-panel" hidden><header><h2>Notifications</h2><button className="tiny" type="button" aria-label="Close notifications">×</button></header><div id="alert-list" className="queue-list" /></section></div>
      <div className="queue-dock"><section id="queue-panel" className="queue-panel" hidden><header><h2>AI Queue</h2><button className="tiny" type="button" aria-label="Close queue">×</button></header><div id="queue-list" className="queue-list" aria-live="polite" /></section><button id="queue-toggle" className="queue-toggle" aria-label="AI Queue" aria-expanded="false" data-active="false">◴</button></div>
