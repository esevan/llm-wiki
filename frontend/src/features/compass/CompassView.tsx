    ...
    <section id="compass" className={`view${active ? ' active' : ''}`}>
      ...
      <section className="quick">
        ...
        <form className="capture" id="goal-form">
          <input id="goal-title" aria-label="Direction goal" placeholder="e.g. Make decisions easier to reuse" required />
          <IconButton kind="primary" label="Add goal" labelVisible>+</IconButton>
        </form>
      </section>
